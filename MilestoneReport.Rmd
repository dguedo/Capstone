...
findFreqTerms(tdm1, lowfreq = 90)[1:25]
...
#findFreqTerms(ff, lowfreq=100)
#findFreqTerms(ngram, lowfreq = 6)[1:25]

#ft <- findFreqTerms(tdm, lowfreq = 6)[1:25]

#findFreqTerms(ff, lowfreq=100)
#findFreqTerms(uni, lowfreq = 100)[1:25]
###
#findFreqTerms(tdm, lowfreq = 6)[1:25]
###
#findFreqTerms(tr, lowfreq = 3)[1:25]
